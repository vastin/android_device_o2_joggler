        ...
        struct light_state_t const* state)
{
    ...
    err = write_int("/sys/class/backlight/openframe-bl/brightness", brightness>>3); // eeepc brightness range: 0 - 15
...
const struct hw_module_t HAL_MODULE_INFO_SYM = {
    ...
    .name = "joggler lights Module",
    .author = "kelly2.blue@gmail.com,mijuuxp@gmail.com",
